...
<div align="center">
        ...
        <form:form action="/shivi/saveUser" method="get" modelAttribute="contact">
        ...
        <table>
         ...
         <tr><td> 
                ...
                <tr><td> <input type="hidden" name="sn_id" value="${contact.id}"/></td></tr>
                  <tr><td> <input type="hidden" name="image" value="${contact.id}"/></td></tr>
                    <tr><td> <input type="hidden" name="role" value="ROLE_USER"/></td></tr>
            ...
            <td><input type="password" required/></td></tr>
            <tr>
